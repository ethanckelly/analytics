...
** PIE CHART OF NEW HOUSE COMPOSITION HERE ** 
...
To gauge a further level of accuracy, we will be exploring the Root Mean Square Error of the prediction vs. the observation (the result). When running the RMSE calculation, we find that the Root Mean Square Error is 0.198. This is not that good – especially given that it otherwise seemed more accurate based on the 17 seats being off. However, this did not translate to a more secure number in the RMSE calculation. Though, on the topic of accuracy, I’d argue that my model was quite accurate, even if I did not think it would be on election day. 
