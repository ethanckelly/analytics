...
popvote_df <- read_csv("inc_pop_vote_df.csv") # update here
economy_df <- read_csv("GDP_quarterly.csv") # update here
poll_df <- read_csv("polls_df.csv") # update here
...
dat_econ_inc <- dat_econ[dat_econ$H_incumbent_party_winner,]
dat_econ_chl <- dat_econ[!dat_econ$H_incumbent_part_winner,]
